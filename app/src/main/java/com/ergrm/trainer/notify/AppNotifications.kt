 ...
 *  action. Only posted on success — a failure's only signal stays the error text in Settings.
 *  Shares [com.ergrm.trainer.backup.BackupReminderReceiver]'s channel and icon, with its own
 *  notification ids so none of the four ever overwrite each other. */
